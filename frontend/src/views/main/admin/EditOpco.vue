...
import { IOpcoRecord, IUserProfile, IUserProfileUpdate } from '@/interfaces';
import { dispatchGetOpco, dispatchGetUsers, dispatchUpdateUser } from '@/store/admin/actions';
import { readAdminOneUser, readAdminOpco } from '@/store/admin/getters';
...
export default class EditUser extends Vue {
  ...
  public opco: IOpcoRecord|null = null;
